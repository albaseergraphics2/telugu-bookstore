...
export default function OfflineOrders() {
    ...
    const fetchOrders = async () => {
        try {
            setLoading(true);
            const res = await fetch("/api/admin/online/orders", {
                method: "GET",
                cache: "no-store",
            });
    ...
    const receivePayment = async (
        ...
        try {
            const res = await fetch(`/api/admin/online/orders/${orderId}/payment`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
                                            ...
                                            {(order.paymentMethod === "online" ||
                                                order.paymentMethod === "bank") && (
                                                    <div className="payment-received-details">
                                                        <div className="payment-received-row">
                                                            <div>
